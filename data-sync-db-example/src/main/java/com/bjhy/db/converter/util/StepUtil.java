...
//			incrementalSync.getAlarmColumn().add("SYS_ORGNAME");
	 ...
	 * @param simpleColumnNameMapping 简单的字段映射
	 */
	public static void checkSyncNotNullWhere3NoOrder(SingleRunEntity singleRunEntity,String uniqueKey,String fromSelectPart,String fromFromPart,String toTableName,String updateAndPageColumn,String singleStepListenerName,Map<String,String> simpleColumnNameMapping){
		   BaseCore baseCore = new BaseCore();
